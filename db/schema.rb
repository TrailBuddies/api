...
ActiveRecord::Schema.define(version: 2022_07_26_131225) do
  ...
  create_table "hike_events", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.uuid "user_id", null: false
    t.uuid "users", default: [], null: false, array: true
    t.uuid "users_unconfirmed", default: [], null: false, array: true
    t.index ["user_id"], name: "index_hike_events_on_user_id"
  end
  ...
  create_table "users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "avatar_url", default: "default-avatar", null: false
