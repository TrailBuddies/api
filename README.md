...
| [`rails-erd`](https://rubygems.org/gems/rails-erd) | `'~> 1.6.0'` | [RubyDoc](https://rubydoc.info/github/voormedia/rails-erd/) | To generate `/docs/ERD.png`. (**E**ntity **R**elationship **D**iagram) |
